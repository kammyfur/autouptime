...
module.exports = () => {
    ...
    output = [ { update: (new Date().getDate()) + "/" + (new Date().getMonth() + 1) + "/" + (new Date().getFullYear()) + " " + (new Date().getHours()) + ":" + (new Date().getMinutes()), maintenance: config.maintenance, maintenanceReason: config.maintenanceReason } ];
                    ...
                    resp.on('end', () => {
                        ...
                        if (resp.statusCode == 200) {
                            ...
                            output.push({
                                ...
                                domain: element.dns,
                                status: 0,
                                message: "Operational (" + resp.statusCode + ")",
